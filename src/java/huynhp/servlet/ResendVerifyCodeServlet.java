 ...
 * @author MSI
 */
@WebServlet(name = "ResendVerifyCodeServlet", urlPatterns = {"/ResendVerifyCodeServlet"})
public class ResendVerifyCodeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (isSent) {
                msg = "Resent verify code already!";
